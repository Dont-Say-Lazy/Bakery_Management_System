...
<h1>Confirm Edit User</h1>

<div style="background-color: #d4edda; color: #155724; padding: 10px; margin-bottom: 15px; border-radius: 5px;">
    Please confirm that you want to update this user with the following information:
</div>
...
<form action="<%= request.getContextPath() %>/user" method="post">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <a href="<%= request.getContextPath() %>/user?action=showEditForm&userID=<%= request.getAttribute("userID") %>" class="btn" style="background-color: #f44336; color: white;">Cancel</a>
    </div>
</form>
